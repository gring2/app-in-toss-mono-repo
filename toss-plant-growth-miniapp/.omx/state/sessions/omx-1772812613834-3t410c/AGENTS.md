...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1772812613834-3t410c | 2026-03-06T15:56:53.857Z

**Codebase Map:**
  src/: _app, router.gen
  src/ads/: pacing
  src/components/: CompareSlider
  src/content/: copy
  src/detection/: plantDetector, cvModelDetector, heuristicPlantDetector
  src/hooks/: usePlantGrowth
  src/pages/: about, capture, compare, timeline
  src/plants/: image, store
  src/reports/: dailyReport, scoring
  src/ui/: theme
  pages/: _404, about, capture, compare, timeline
  (root): babel.config, granite.config, jest.config, jest.setup, react-native.config, require.context
