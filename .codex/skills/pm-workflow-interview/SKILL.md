---
name: "pm-workflow-interview"
description: "Prepare a customer interview script or summarize an interview transcript into structured insights in Codex. Codex wrapper for Claude's /interview command."
---

# PM Workflow: Interview

This skill is the Codex conversion of Claude's `/interview` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-interview [prep|summarize] <topic or transcript>`
- Original Claude argument hint: `[prep|summarize] <topic or transcript>`
- Source plugin: `pm-product-discovery`
- Original Claude command: `/interview`
