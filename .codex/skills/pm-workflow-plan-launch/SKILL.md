...
description: "Create a full go-to-market strategy in Codex. Codex wrapper for Claude's /plan-launch command."
---

# PM Workflow: Plan Launch

This skill is the Codex conversion of Claude's `/plan-launch` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-plan-launch <product or feature to launch>`
- Original Claude argument hint: `<product or feature to launch>`
- Source plugin: `pm-go-to-market`
- Original Claude command: `/plan-launch`
