---
name: "pm-workflow-analyze-test"
description: "Analyze A/B test results in Codex. Codex wrapper for Claude's /analyze-test command."
---

# PM Workflow: Analyze Test

This skill is the Codex conversion of Claude's `/analyze-test` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-analyze-test <test results as data, screenshot, or description>`
- Original Claude argument hint: `<test results as data, screenshot, or description>`
- Source plugin: `pm-data-analytics`
- Original Claude command: `/analyze-test`
