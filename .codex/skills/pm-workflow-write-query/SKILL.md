---
name: "pm-workflow-write-query"
description: "Generate SQL queries from natural language in Codex. Codex wrapper for Claude's /write-query command."
---

# PM Workflow: Write Query

This skill is the Codex conversion of Claude's `/write-query` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-write-query <what you want to know, in plain English>`
- Original Claude argument hint: `<what you want to know, in plain English>`
- Source plugin: `pm-data-analytics`
- Original Claude command: `/write-query`
