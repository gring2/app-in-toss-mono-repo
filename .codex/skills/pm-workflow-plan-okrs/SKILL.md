---
name: "pm-workflow-plan-okrs"
description: "Brainstorm team-level OKRs aligned with company objectives in Codex. Codex wrapper for Claude's /plan-okrs command."
---

# PM Workflow: Plan OKRs

This skill is the Codex conversion of Claude's `/plan-okrs` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-plan-okrs <team, product area, or company objective>`
- Original Claude argument hint: `<team, product area, or company objective>`
- Source plugin: `pm-execution`
- Original Claude command: `/plan-okrs`
