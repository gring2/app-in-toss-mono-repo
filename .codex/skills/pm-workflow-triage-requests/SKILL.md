---
name: "pm-workflow-triage-requests"
description: "Analyze, categorize, and prioritize a batch of feature requests from customers or stakeholders in Codex. Codex wrapper for Claude's /triage-requests command."
---

# PM Workflow: Triage Requests

This skill is the Codex conversion of Claude's `/triage-requests` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-triage-requests <feature requests as text, file, or paste>`
- Original Claude argument hint: `<feature requests as text, file, or paste>`
- Source plugin: `pm-product-discovery`
- Original Claude command: `/triage-requests`
