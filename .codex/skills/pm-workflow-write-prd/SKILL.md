---
name: "pm-workflow-write-prd"
description: "Create a comprehensive Product Requirements Document from a feature idea or problem statement in Codex. Codex wrapper for Claude's /write-prd command."
---

# PM Workflow: Write PRD

This skill is the Codex conversion of Claude's `/write-prd` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-write-prd <feature or problem statement>`
- Original Claude argument hint: `<feature or problem statement>`
- Source plugin: `pm-execution`
- Original Claude command: `/write-prd`
