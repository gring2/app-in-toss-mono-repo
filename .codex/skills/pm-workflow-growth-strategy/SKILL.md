---
name: "pm-workflow-growth-strategy"
description: "Design sustainable growth mechanisms in Codex. Codex wrapper for Claude's /growth-strategy command."
---

# PM Workflow: Growth Strategy

This skill is the Codex conversion of Claude's `/growth-strategy` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-growth-strategy <product or growth challenge>`
- Original Claude argument hint: `<product or growth challenge>`
- Source plugin: `pm-go-to-market`
- Original Claude command: `/growth-strategy`
