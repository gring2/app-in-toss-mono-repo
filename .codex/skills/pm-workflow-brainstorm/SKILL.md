---
name: "pm-workflow-brainstorm"
description: "Brainstorm product ideas or experiments from PM, Designer, and Engineer perspectives in Codex. Codex wrapper for Claude's /brainstorm command."
---

# PM Workflow: Brainstorm

This skill is the Codex conversion of Claude's `/brainstorm` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-brainstorm [ideas|experiments] [existing|new] <product or feature description>`
- Original Claude argument hint: `[ideas|experiments] [existing|new] <product or feature description>`
- Source plugin: `pm-product-discovery`
- Original Claude command: `/brainstorm`
