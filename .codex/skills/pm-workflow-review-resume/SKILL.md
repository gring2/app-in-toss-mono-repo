---
name: "pm-workflow-review-resume"
description: "Comprehensive PM resume review against 10 best practices in Codex. Codex wrapper for Claude's /review-resume command."
---

# PM Workflow: Review Resume

This skill is the Codex conversion of Claude's `/review-resume` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-review-resume <resume as text or file>`
- Original Claude argument hint: `<resume as text or file>`
- Source plugin: `pm-toolkit`
- Original Claude command: `/review-resume`
