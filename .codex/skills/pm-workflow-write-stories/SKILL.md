---
name: "pm-workflow-write-stories"
description: "Break a feature into backlog items in Codex. Codex wrapper for Claude's /write-stories command."
---

# PM Workflow: Write Stories

This skill is the Codex conversion of Claude's `/write-stories` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-write-stories [user|job|wwa] <feature description or PRD>`
- Original Claude argument hint: `[user|job|wwa] <feature description or PRD>`
- Source plugin: `pm-execution`
- Original Claude command: `/write-stories`
