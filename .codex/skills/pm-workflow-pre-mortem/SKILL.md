---
name: "pm-workflow-pre-mortem"
description: "Run a pre-mortem risk analysis on a PRD, launch plan, or feature in Codex. Codex wrapper for Claude's /pre-mortem command."
---

# PM Workflow: Pre Mortem

This skill is the Codex conversion of Claude's `/pre-mortem` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-pre-mortem <PRD, plan, or feature description>`
- Original Claude argument hint: `<PRD, plan, or feature description>`
- Source plugin: `pm-execution`
- Original Claude command: `/pre-mortem`
