---
name: "pm-workflow-research-users"
description: "Comprehensive user research in Codex. Codex wrapper for Claude's /research-users command."
---

# PM Workflow: Research Users

This skill is the Codex conversion of Claude's `/research-users` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-research-users <research data, survey results, or product description>`
- Original Claude argument hint: `<research data, survey results, or product description>`
- Source plugin: `pm-market-research`
- Original Claude command: `/research-users`
