...
description: "Analyze the competitive landscape in Codex. Codex wrapper for Claude's /competitive-analysis command."
---

# PM Workflow: Competitive Analysis

This skill is the Codex conversion of Claude's `/competitive-analysis` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-competitive-analysis <your product or market>`
- Original Claude argument hint: `<your product or market>`
- Source plugin: `pm-market-research`
- Original Claude command: `/competitive-analysis`
