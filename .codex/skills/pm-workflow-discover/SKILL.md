...
description: "Run a full product discovery cycle in Codex. Codex wrapper for Claude's /discover command."
---

# PM Workflow: Discover

This skill is the Codex conversion of Claude's `/discover` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-discover <product or feature idea>`
- Original Claude argument hint: `<product or feature idea>`
- Source plugin: `pm-product-discovery`
- Original Claude command: `/discover`
