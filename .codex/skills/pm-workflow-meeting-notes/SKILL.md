...
description: "Summarize a meeting transcript into structured notes with decisions, action items, and follow-ups in Codex. Codex wrapper for Claude's /meeting-notes command."
---

# PM Workflow: Meeting Notes

This skill is the Codex conversion of Claude's `/meeting-notes` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-meeting-notes <transcript or meeting notes>`
- Original Claude argument hint: `<transcript or meeting notes>`
- Source plugin: `pm-execution`
- Original Claude command: `/meeting-notes`
