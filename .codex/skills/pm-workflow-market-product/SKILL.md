...
description: "Brainstorm marketing ideas, positioning, value prop statements, and product names in Codex. Codex wrapper for Claude's /market-product command."
---

# PM Workflow: Market Product

This skill is the Codex conversion of Claude's `/market-product` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-market-product <product or marketing challenge>`
- Original Claude argument hint: `<product or marketing challenge>`
- Source plugin: `pm-marketing-growth`
- Original Claude command: `/market-product`
