---
name: "pm-workflow-north-star"
description: "Define your North Star Metric and supporting input metrics in Codex. Codex wrapper for Claude's /north-star command."
---

# PM Workflow: North Star

This skill is the Codex conversion of Claude's `/north-star` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-north-star <product or business>`
- Original Claude argument hint: `<product or business>`
- Source plugin: `pm-marketing-growth`
- Original Claude command: `/north-star`
