---
name: "pm-workflow-analyze-cohorts"
description: "Perform cohort analysis on user data in Codex. Codex wrapper for Claude's /analyze-cohorts command."
---

# PM Workflow: Analyze Cohorts

This skill is the Codex conversion of Claude's `/analyze-cohorts` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-analyze-cohorts <data file or description of what to analyze>`
- Original Claude argument hint: `<data file or description of what to analyze>`
- Source plugin: `pm-data-analytics`
- Original Claude command: `/analyze-cohorts`
