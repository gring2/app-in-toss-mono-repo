---
name: "pm-workflow-analyze-feedback"
description: "Analyze user feedback at scale in Codex. Codex wrapper for Claude's /analyze-feedback command."
---

# PM Workflow: Analyze Feedback

This skill is the Codex conversion of Claude's `/analyze-feedback` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-analyze-feedback <feedback data as CSV, text, or file>`
- Original Claude argument hint: `<feedback data as CSV, text, or file>`
- Source plugin: `pm-market-research`
- Original Claude command: `/analyze-feedback`
