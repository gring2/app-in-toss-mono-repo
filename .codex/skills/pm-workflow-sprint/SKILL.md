...
description: "Sprint lifecycle in Codex. Codex wrapper for Claude's /sprint command."
---

# PM Workflow: Sprint

This skill is the Codex conversion of Claude's `/sprint` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-sprint [plan|retro|release-notes] <context>`
- Original Claude argument hint: `[plan|retro|release-notes] <context>`
- Source plugin: `pm-execution`
- Original Claude command: `/sprint`
