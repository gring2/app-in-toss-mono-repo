---
name: "pm-workflow-business-model"
description: "Explore business models using Lean Canvas, Business Model Canvas, Startup Canvas, or Value Proposition frameworks in Codex. Codex wrapper for Claude's /business-model command."
---

# PM Workflow: Business Model

This skill is the Codex conversion of Claude's `/business-model` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-business-model [lean|full|startup|value-prop] <product or business>`
- Original Claude argument hint: `[lean|full|startup|value-prop] <product or business>`
- Source plugin: `pm-product-strategy`
- Original Claude command: `/business-model`
