...
description: "Generate realistic dummy datasets for testing in Codex. Codex wrapper for Claude's /generate-data command."
---

# PM Workflow: Generate Data

This skill is the Codex conversion of Claude's `/generate-data` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-generate-data <description of the data you need>`
- Original Claude argument hint: `<description of the data you need>`
- Source plugin: `pm-execution`
- Original Claude command: `/generate-data`
