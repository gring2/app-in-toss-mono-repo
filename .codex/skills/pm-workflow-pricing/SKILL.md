---
name: "pm-workflow-pricing"
description: "Design a pricing strategy in Codex. Codex wrapper for Claude's /pricing command."
---

# PM Workflow: Pricing

This skill is the Codex conversion of Claude's `/pricing` command from the PM Skills Marketplace.
...
## Codex Usage
- Recommended invocation: `$pm-workflow-pricing <product or pricing question>`
- Original Claude argument hint: `<product or pricing question>`
- Source plugin: `pm-product-strategy`
- Original Claude command: `/pricing`
